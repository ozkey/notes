 ...
 */
class BibleBookmark extends PluginCommand {
  ...
  constructor(kernel: CoreKernel) {
    ...
    this.icon = '<span style="font-size:14px">🔖</span>';
    // members
  ...
  active(
    ...
    target: Node | SunEditor.NodeCollection,
  ) {
   ...
   */
  action() {
    const currentBlockquote = dom.query.getParentElement(
