...
when the user clicks on the highlighter button, a menu should appear with all the verse numbers that have been
highlighted in the current chapter,
allowing the user to select the verse they want to make a note against.

when the user selects a verse number, a badge with the verse number should be added to the notes allowing the
user to then type the note in the editor.

the badge should have the same color as the highlight, and should be displayed in the notes panel, allowing the user to easily reference and review their notes later.